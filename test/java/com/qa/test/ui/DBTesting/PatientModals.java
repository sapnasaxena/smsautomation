...
public class PatientModals {
	...
	public static PatientModals getDefaultPatientDetails(){
		PatientModals patientModal = new PatientModals();
...
//	{
//		PatientModals patientModal = getDefaultPatientDetails();
